...
<html> 
    <head> 
        ...
        <title> LENDER PROFILE | FASTeLoan.com</title>  
        </Link>
    </head>  
            ...
            <center>
                <div id="navbar">
                    <ul>
                         ...
                         <a href="Lender_home.php#about" id="linkref" >ABOUT US </a>
                         <a href="faq/indexl.php" id="linkref" >FAQs </a>	
                         <a href="Lender_home.php#contact" id="linkref" >CONTACT US </a>
                    </ul>
                </div>
            </center>		 
        </header>
                    ...
                    <div class="col-xs-9">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="account">
                                <?php
									...
									if (!$conn) {
									  ...
									  $id = $_SESSION['leID'];
									$sql = "SELECT  Name,dob,email,mob,address,pincode,city,state FROM lenders WHERE leID='$id'";
                            ...
                            <div class="tab-pane" id="cpass">
                                <form class="f1" role="form" method ="post" action="" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="account">Lender ID:</label>
                                        <input type="text" class="form-control" name ="lid" id="ac" placeholder="*Enter your Lender ID">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="pwd" size="40"   onkeypress= "strength_pwd()" placeholder=" *Enter New Password">
                                    </div>
                            ...
                            <div class="tab-pane" id="edit">
                                <form class="f1" role="form" method ="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="EMAIL"  size="40" class="form-control" id="email" placeholder = "Enter new Email Id "> 
                                        
                                    </div>
				 
                                    <div class="form-group">
                                        <label for="phn">Phone No.:</label>
                                        <input type="text" name="PHONE" size="10" class="form-control" id="phone" placeholder="Enter new phone no."> 				  
                                    </div>
